...
def test_fractional_fill_precision(
...
def test_partial_fill_response(
    ...
    assert payload["unfilled_quantity"] == 0.005


def test_disconnected_terminal_safe_error(
