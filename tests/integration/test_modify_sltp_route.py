...
def test_modify_sltp_success(client, auth_headers, mock_mt5_submit, completed_future_factory):
...
def test_modify_sltp_execution_disabled(client, auth_headers, monkeypatch):
    from app.main import settings
